          ...
          {editing && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3">
                <button type="submit" className="px-5 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-semibold hover:bg-indigo-700 shadow-sm transition-all">
                  {myReview ? 'Update' : 'Submit'}
                </button>
                <button type="button" onClick={() => setEditing(false)}
                  className="px-5 py-2.5 border border-gray-200 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-50 transition-all">Cancel</button>
                {myReview && (
                  <button type="button" onClick={handleDelete}
                    className="px-5 py-2.5 text-red-500 rounded-xl text-sm font-semibold hover:bg-red-50 transition-all">Delete</button>
                )}
              </div>
            </form>
          )}
